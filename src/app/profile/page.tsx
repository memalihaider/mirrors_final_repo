...
// import { User, Mail, Shield, Calendar, Edit3, Save, Crown } from 'lucide-react';
...
//         {/* Messages */}
//         {message && (
//           <div className="mb-3 p-2 sm:p-3 bg-green-50 border border-green-200 rounded-lg text-center">
//             <p className="text-green-600 text-xs sm:text-sm">{message}</p>
//           </div>
//         )}

//         {error && (
//           <div className="mb-3 p-2 sm:p-3 bg-red-50 border border-red-200 rounded-lg text-center">
//             <p className="text-red-600 text-xs sm:text-sm">{error}</p>
//           </div>
//         )}
...
//           <div className="bg-white/90 backdrop-blur-xl border border-pink-200/30 rounded-xl sm:rounded-2xl shadow-[0_8px_30px_rgb(233,30,99,0.15)] p-3 sm:p-4 w-full max-w-md">
//             {/* Profile Header */}
//             <div className="flex flex-col items-center justify-center mb-4 space-y-2">
//               <div className="w-14 h-14 rounded-xl flex items-center justify-center bg-gradient-to-br from-yellow-400 to-orange-500">
//                 <Crown className="w-6 h-6 sm:w-7 sm:h-7 text-white" />
//               </div>
//               <div>
//                 <h2 className="text-sm sm:text-base font-bold text-gray-900">
...
//                 </h2>
//                 <p className="text-xs text-gray-500 truncate">{user?.email}</p>
//                 <div className="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium mt-1 bg-yellow-100 text-yellow-700 border border-yellow-200">
//                   <Crown className="w-3 h-3 mr-1" />
//                   Admin
//                 </div>
//               </div>
...
//                   <p className="text-xs text-gray-500">Role</p>
//                   <p className="text-xs font-medium text-gray-900 capitalize">  admin
//                   </p>
//                 </div>
//               </div>
...
//           <div className="bg-blue-50/50 border border-blue-200/50 rounded-xl p-3 w-full max-w-md">
//             <div className="flex items-start space-x-2">
//               <div className="w-6 h-6 bg-blue-100 rounded-lg flex items-center justify-center flex-shrink-0">
//                 <Shield className="w-3 h-3 text-blue-600" />
//               </div>
//               <div>
//                 <h4 className="text-xs font-semibold text-blue-900 mb-1 text-center">Account Security</h4>
...
export default function ProfilePage() {
  const { user, userRole } = useAuth(); // ✅ move inside component
  const [editing, setEditing] = useState(false);
  const [displayName, setDisplayName] = useState(user?.displayName || '');
  const [loading, setLoading] = useState(false);
  const [message, setMessage] = useState('');
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center space-x-2 p-2 bg-gray-50 rounded-lg">
                  ...
                  <div className="text-left">
                    <p className="text-xs text-gray-500">Role</p>
                    <p className="text-xs font-medium text-gray-900">
                      {userRole?.role || 'User'} {/* ✅ fixed: dynamic userRole display */}
                    </p>
                  </div>
                </div>
