              ...
              <tbody>
                {filteredBookings.map((b) => (
                  <tr key={b.id} className="hover:bg-gray-50 cursor-pointer" onClick={() => openForEdit(b)}>
                    ...
                    <td className="px-4 py-3">${b.totalPrice.toFixed(2)} <div className="text-xs text-gray-500">{b.paymentMethod}</div></td>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            <div className="bg-white p-4 rounded shadow">
              ...
              <div className="text-xl font-semibold">${financeTotals.grossSales?.toFixed(2) || '0.00'}</div>
            </div>
            <div className="bg-white p-4 rounded shadow">
              <div className="text-sm text-gray-500">Net Sales</div>
              <div className="text-xl font-semibold">${financeTotals.sales?.toFixed(2) || '0.00'}</div>
            </div>
            <div className="bg-white p-4 rounded shadow">
              <div className="text-sm text-gray-500">Tax</div>
              <div className="text-xl font-semibold">${financeTotals.tax?.toFixed(2) || '0.00'}</div>
            </div>
            <div className="bg-white p-4 rounded shadow">
              <div className="text-sm text-gray-500">In-Hand Collection</div>
              <div className="text-xl font-semibold">${financeTotals.inHandCollection?.toFixed(2) || '0.00'}</div>
            </div>
          </div>
            ...
            <table className="min-w-full">
              ...
              <tbody>
                <tr>
                  ...
                  <td className="px-4 py-2 text-right">${financeTotals.sales?.toFixed(2) || '0.00'}</td>
                </tr>
                <tr>
                  <td className="px-4 py-2">Gross Sales</td>
                  <td className="px-4 py-2 text-right">${financeTotals.grossSales?.toFixed(2) || '0.00'}</td>
                </tr>
                <tr>
                  <td className="px-4 py-2">Discount</td>
                  <td className="px-4 py-2 text-right">${financeTotals.discount?.toFixed(2) || '0.00'}</td>
                </tr>
                <tr>
                  <td className="px-4 py-2">Refunds</td>
                  <td className="px-4 py-2 text-right">${financeTotals.refunds?.toFixed(2) || '0.00'}</td>
                </tr>
                <tr>
                  <td className="px-4 py-2">Adjustments</td>
                  <td className="px-4 py-2 text-right">${financeTotals.adjustments?.toFixed(2) || '0.00'}</td>
                </tr>
                <tr>
                  <td className="px-4 py-2">Tax</td>
                  <td className="px-4 py-2 text-right">${financeTotals.tax?.toFixed(2) || '0.00'}</td>
                </tr>
                <tr>
                  <td className="px-4 py-2">Total Sales (Tax + Net)</td>
                  <td className="px-4 py-2 text-right">${financeTotals.totalSalesWithTax?.toFixed(2) || '0.00'}</td>
                </tr>
                <tr>
                  <td className="px-4 py-2">Tips</td>
                  <td className="px-4 py-2 text-right">${financeTotals.tips?.toFixed(2) || '0.00'}</td>
                </tr>
                <tr>
                  <td className="px-4 py-2">Collection (Sales + Tips)</td>
                  <td className="px-4 py-2 text-right">${financeTotals.collection?.toFixed(2) || '0.00'}</td>
                </tr>
                <tr>
                  <td className="px-4 py-2">Excluded Payments</td>
                  <td className="px-4 py-2 text-right">${financeTotals.excludedPayments?.toFixed(2) || '0.00'}</td>
                </tr>
                <tr>
                  <td className="px-4 py-2">In-Hand Collection</td>
                  <td className="px-4 py-2 text-right">${financeTotals.inHandCollection?.toFixed(2) || '0.00'}</td>
                </tr>
                ...
                {Object.entries(financeTotals.paymentMethods || {}).map(([pm, amt]) => (
                  <tr key={pm} className="border-t">
                    ...
                    <td className="px-4 py-2 text-right">${(Number(amt)||0).toFixed(2)}</td>
                  </tr>
                ))}
                ...
                {financeFiltered.map((b)=>{
                  ...
                  return (
                    <tr key={b.id} className="hover:bg-gray-50 cursor-pointer" onClick={()=>openForEdit(b)}>
                      ...
                      <td className="px-4 py-2 text-right">${discount.toFixed(2)}</td>
                      <td className="px-4 py-2 text-right">${refunds.toFixed(2)}</td>
                      <td className="px-4 py-2 text-right">${adjustments.toFixed(2)}</td>
                      <td className="px-4 py-2 text-right">${net.toFixed(2)}</td>
                      <td className="px-4 py-2 text-right">${tax.toFixed(2)}</td>
                      <td className="px-4 py-2 text-right">${(net+tax).toFixed(2)}</td>
                      <td className="px-4 py-2 text-right">${tips.toFixed(2)}</td>
